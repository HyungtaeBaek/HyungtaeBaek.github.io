...
A $w$-module $M$ is said to admit a <i>$w$-secondary representation</i> if<center>$M=(N_1+\cdots+N_n)_w$,</center>
where, for each $i=1,\dots,n$, $N_{i}$ is a $w$-secondary submodule of $M$ and $P_{i}=\sqrt{\text{Ann}(N_{i})}$.
...
Moreover, if<center>$M=(N_{1}\oplus\cdots\oplus N_{n})_{w},$</center>
