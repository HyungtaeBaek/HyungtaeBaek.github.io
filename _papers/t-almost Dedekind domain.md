...
A GV-torsion-free $R$-module $M$ is called \emph{$w$-secondary} if, for every $r\in R$, either $M/rM$ is GV-torsion or $r^{n}M=0$ for some $n\in\mathbb{N}$.
...
$P_{i}=\sqrt{\Ann(N_{i})}$ are pairwise distinct, then $M$ is called
